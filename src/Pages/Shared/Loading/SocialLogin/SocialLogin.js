    ...
    return (
        <div>
            ...
            <div className="d-grid gap-2">
                <Button onClick={handleGoogleSignIn} variant="outline-warning" size="lg">
                    <img className='me-4' src={google} alt="" /> Google Signup
                </Button>
                <Button onClick={() => signInWithGithub()} variant="outline-warning" size="lg">
