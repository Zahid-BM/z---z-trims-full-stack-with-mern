    ...
    return (
        <>
            <Container fluid className='my-5 shadow-lg bg-light pt-5'>
                <h1 className='text-center mt-4 fw-bold text-info'>New Items Nomination <img src={approval} alt="" /></h1>
                <p className='text-center text-secondary'>Below items are now verified from buyers to go for bulk production</p>
                <Row >
                    <Col lg={8}>
                    ...
                    <Col className='mt-3' lg={4}>
                        <h1 className='fw-bolder display-5 '><span className='text-warning'>2022</span> <span className='text-info'>Nomination</span></h1>
