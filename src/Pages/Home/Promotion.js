    ...
    return (
        <>
            <Container fluid className='my-5 shadow-lg bg-light pt-5'>
                ...
                <p className='text-center text-success'>Below items are now verified from buyers to go for bulk production</p>
                <Row >
                    <Col lg={8}>
                    ...
                    <Col className='mt-3' lg={4}>
                        <h1 className='fw-bolder display-5 '><span className='text-secondary'>2022</span> <span className='text-success'>Nomination</span></h1>
                        ...
                        <h4 className='text-center mt-5'>List of the new items</h4>
